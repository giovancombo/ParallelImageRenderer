...
ParallelResult Renderer::renderParallel(int num_threads, int block_size, float seq_execution_time) {
    ParallelResult result;

    result.numThreads = num_threads;
    ...
    result.speedup = seq_execution_time/result.parExecutionTime;
